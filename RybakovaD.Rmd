...
train_mse_dt
test_mse_dt
#Висновок: значення середньоквадратичної похибки на навчальній вибірці – 13.90709, на тестовій вибірці – 26.28905. Модель перенавчено. Прогноз невірний.

#Visualising
library(ggplot2)
x_grid <- seq(min(f_train$Life), max(f_train$Life), 0.01)
ggplot() +
  geom_point(aes(f_train$TH59, f_train$Life),colour = 'yellow') +
  geom_point(aes(f_test$TH59, f_test$Life),colour = 'green') +
...
train_mse_rf
test_mse_rf
#Висновок: значення середньоквадратичної похибки на навчальній вибірці – 13.8867, на тестовій вибірці – 25.8839. Модель перенавчено. Прогноз невірний.
